...
-- In this task, I will write a conditional
...
-- In this task, I will add multiple conditions to a 
-- CASE statement
...
SELECT customer_id, customer_name, country, region,
CASE
...
SELECT first_name, last_name, gender, emp_no, hire_date, EXTRACT(YEAR FROM hire_date) AS Year,
CASE
...
-- In this task, I will use the CASE clause and
...
-- In this task, I will use the CASE clause together with
...
/* 5.3: Retrieve a list of managers employee number, first name and last name.
...
-- In this task, I will use the SQL CASE statement to
